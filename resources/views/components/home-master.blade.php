...
{{--    Paste Analytics HERE--}}
    ...
    <meta name="data-image" content="https://hamptonstileandgrout.com/storage/index_htm_files/tile_&_grout_cleaning_portland-1.png">
    <meta property="og:title" content="Hampton's Tile & Grout">
    <meta property="og:description" content="Hampton’s Tile &amp; Grout - Our goal is to restore existing installations through renovation and help maintain newer installations in pristine condition for a significantly longer life. We are a locally owned and operated licensed contractor servicing homeowners, hotels, restaurants, apartments and commercial properties throughout Oregon and Washington.">
    <meta property="og:image" content="https://hamptonstileandgrout.com/storage/index_htm_files/tile_&_grout_cleaning_portland-1.png">
    <meta property="og:url" content="https://hamptonstileandgrout.com/">
...
<div class="sharethis-sticky-share-buttons"
     data-url="https://hamptonstileandgrout.com"
...
<script>
    // Select the element(s) you want to set the data-image property for
    var shareButton = document.getElementById('st-1');

    // Set the data-image property dynamically
    shareButton.dataset.image = 'https://hamptonstileandgrout.com/storage/index_htm_files/tile_&_grout_cleaning_portland-1.png';
</script>
